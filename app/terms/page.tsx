    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      ...
      <div className="prose prose-lg max-w-none text-gray-700">
        ...
        <p>
          ...
          terms, then you do not have permission to access the Site.
        </p>
        ...
        <p>
          ...
          the Steven V. Ceceri for State Representative campaign and its licensors. The content is protected by
          copyright, trademark, and other laws of both the United States and foreign countries. Our trademarks and trade
        ...
        <p>
          ...
          third-party websites or services. We do not warrant the offerings of any of these entities/individuals or
          their websites.
        </p>
        ...
        <p>
          In no event shall the Steven V. Ceceri for State Representative campaign, nor its directors, employees,
        ...
        <p>
          These Terms shall be governed and construed in accordance with the laws of the Commonwealth of Massachusetts,
        ...
        <h2>9. Contact Us</h2>
        <p>If you have any questions about these Terms, please contact us at info@ceceriforma.com.</p>
      </div>
    </div>
  )
}
