    ...
    <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
      <div className="text-center mb-12">
        ...
        <p className="text-xl text-gray-600 max-w-3xl mx-auto">
          We want to hear from you. Reach out with questions, concerns, or to
        ...
        <div className="space-y-8">
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="aspect-video bg-gray-200 rounded-lg overflow-hidden">
                <iframe
                  title="Campaign Headquarters Map"
                  src="https://www.google.com/maps?q=1822+North+Main+Street,+Fall+River,+MA+02720&output=embed"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <Card>
              ...
              <CardContent>
                <p className="text-lg font-semibold">(401) 419-4423</p>
